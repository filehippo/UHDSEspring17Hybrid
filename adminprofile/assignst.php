...
<div class="container">
  		<div class="row">
  			<div class="col-md-6 col-md-offset-3">
  				<h1 class="page-header text-center">Assign Classes to student</h1>
...
<!-- This takes the name of the name and sends the input as a post command to the active file called nook.php that inserts to database  -->
				...
				<form class="form-horizontal" role="form" method="POST" action="courseup.php">
...
?>
 ...
 <div class="form-group">
	<label for="street number" class="col-sm-2 control-label">course 1</label>
		<div class="col-sm-10">
...
<!-- The Text Box to add Name  -->
					...
					<div class="form-group">
	<label for="street number" class="col-sm-2 control-label">course 2</label>
		<div class="col-sm-10">
...
<!-- The Text Box to add Street number -->
                                         ...
                                         <div class="form-group">
	<label for="street number" class="col-sm-2 control-label">course 3</label>
		<div class="col-sm-10">
...
<!-- The Text Box to add locations aka restaurants  -->
                ...
                <div class="form-group">
	<label for="street number" class="col-sm-2 control-label">course 4</label>
		<div class="col-sm-10">
<?php
